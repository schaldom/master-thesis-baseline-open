...
export default function Home() {
  ...
  return (
    <Fragment>
      <Head>
        <title>ComicGEN</title>
        <link rel="icon" href="/favicon3.ico" />
      </Head>
      <div className="bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 min-h-screen px-4 py-16 sm:px-6 sm:py-24 md:grid md:place-items-center lg:px-8">
        <main className="flex flex-col justify-center  max-w-3xl w-full align-center">
          ...
          <p className="block text-sm text-center font-medium text-gray-900 text-decoration-line: overline">
            Here you will post your awesome story
          </p>
